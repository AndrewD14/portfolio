...
class AboutMe extends Component {
   ...
   render(){
      return(
         <div id="aboutme" className={this.state.open ? "main content open mx-auto clear-x-margins" : "main content clear-x-margins"}>
            <h1>About Me</h1>
            <div className="row p-2 pb-3 clear-x-margins">
               <div className="col-12">
                  <h3 className="underline">Who Am I?</h3>
                  <img className="float-right about-me-img" src={require(`../../resources/images/aboutme/computer-coding.jpg`)} alt="definition of computer coding" />
            ...
            <div className="row px-2 pb-3 clear-x-margins">
               <div className="col-12">
                  <h3 className="underline">Early Life</h3>
                  <img className="float-right about-me-img" src={require(`../../resources/images/aboutme/eagle-scout-badge.png`)} alt="eagle scout badge" />
            ...
            <div className="row px-2 pb-3 clear-x-margins">
               <div className="col-12">
                  <h3 className="underline">Love for Computers</h3>
                  <img className="float-right about-me-img"src={require(`../../resources/images/aboutme/graduation.jpg`)} alt="graduation caps being thrown up" />
            ...
            <div className="row px-2 pb-3 clear-x-margins">
               <div className="col-12">
                  <h3 className="underline">Extra Activities</h3>
            ...
            <div id="aboutme-slogan" className="row justify-content-center text-center pb-3 clear-x-margins">
               <div className="col-12">
                  ...
                  <img id="aboutme-gif" src={require(`../../resources/images/aboutme/fire-it-crowd.webp`)} alt="scene from IT crowd of fire" />
               </div>
            </div>
         </div>
      );
